...
def main():
    ...
    parser.add_argument('--batch_size', default=1024, type=int, help='batch size (defaults to 10000); does not affect results, larger is usually faster but uses more memory')
